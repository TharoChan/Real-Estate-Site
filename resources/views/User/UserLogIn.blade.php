...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            <h1 class="display-4 fw-bold lh-1 mb-3">Welcome back to H1Z1-Estate</h1>
            <p class="col-lg-10 fs-4">
                This is just bunch of random text you don't need to read it. Stop it already I told you don't read it.
                Fine do whatever you want read this too. It took me F***ing ** Months to make this Project.
            </p>
        </div>
